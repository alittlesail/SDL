...
SDL_DYNAPI_PROC(int,SDL_RenderQuad,(SDL_Renderer *a, SDL_Texture *b, const float *c, const float *d),(a,b,c,d),return)
SDL_DYNAPI_PROC(int,SDL_RenderTriangle,(SDL_Renderer *a, SDL_Texture *b, const float *c, const float *d),(a,b,c,d),return)
...
SDL_DYNAPI_PROC(SDL_RWops*,SDL_RWFromFile,(const char *a, const char *b, SDL_bool c),(a,b,c),return)
